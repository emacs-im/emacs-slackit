...
;; Keywords: comm
;; Version: 0.1.0
;; Package-Requires: ((emacs "28.1") (appkit "0.2.18") (plz "0.8") (websocket "1.16"))
...
;;;###autoload
(defun slackit ()
  "Start or select a Slackit account and open its Appkit root."
  (interactive)
  (let* ((ids (delete-dups
...
(defun slackit-stop-all ()
  "Stop all Slackit accounts and their owned resources."
  (interactive)
