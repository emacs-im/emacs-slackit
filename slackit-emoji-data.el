;;; slackit-emoji-data.el --- Generated Slack standard emoji data -*- lexical-binding: t; -*-

;; Copyright (C) 2026 Slackit contributors

;;; Commentary:

;; Generated from slk's iamcal/emoji-data v16.0.0 table.  Do not edit by hand.

;;; Code:

(defconst slackit-emoji-standard-data
  '[
    ("+1" . "👍")
    ("-1" . "👎")
    ("100" . "💯")
...
;;; slackit-emoji-data.el ends here
